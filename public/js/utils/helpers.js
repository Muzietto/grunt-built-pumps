// Polyfill from https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/indexOf
...
// polyfill from https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Array/forEach
...
// helpers inspired by allong.es
//
function repeatNtimes(times) {
  var count = 0
  ;
...
function once(fn,callback) {
  return repeatNtimes(1)(fn,callback);
}

function twice(fn,callback) {
  return repeatNtimes(2)(fn,callback);
}
