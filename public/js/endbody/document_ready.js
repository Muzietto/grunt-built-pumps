...
var pumpelloOut = WIDGETS.pumpWidget(COMPONENTS.pump(volumello, zenzorAbofe, 50)).init($('#parentDiv'), 100, 350, 'right').paint();
// adds water to basin
var pumpelloIn = WIDGETS.pumpWidget(COMPONENTS.pump(volumello, zenzorBelofe, -40)).init($('#parentDiv'), 50, 350, 'left').paint();
